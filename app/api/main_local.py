...
# Create FastAPI app
app = FastAPI(
    title="RAG Chatbot API (Local Development)",
    description="API for a RAG-enhanced chatbot using Mistral-7B (Local Version)",
    version="1.0.0",
    lifespan=lifespan,
)
...
if __name__ == "__main__":
    uvicorn.run("app.api.main_local:app", host="0.0.0.0", port=8000, reload=True) 